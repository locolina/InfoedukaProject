...
namespace InfoedukaMVC.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(LcolinaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ClassId,ClassName,IsActive")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClassId,ClassName,IsActive")] Class @class)
        {
            if (id != @class.ClassId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LcolinaDbContext.Classes'  is null.");
            }
            var @class = await _context.Classes.FindAsync(id);
            if (@class != null)
            {
